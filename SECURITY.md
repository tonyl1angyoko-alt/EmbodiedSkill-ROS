...
Version 0.1.0 is **not suitable for unsupervised real-robot deployment**. Its JAKA adapter is `STATICALLY-INSPECTED` but `UNVERIFIED` on ROS2 Humble and hardware.
